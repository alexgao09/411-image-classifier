...
def alexnet(learning_rate):
    ...
    model.add(Convolution2D(32, 5, 5, border_mode='same',input_shape=(128,128,3)))
    model.add(Activation('relu'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    
    model.add(Convolution2D(64, 5, 5, border_mode='same',input_shape=(128,128,3)))
    model.add(Activation('relu'))
    model.add(MaxPooling2D(pool_size=(2, 2)))
    ...
    sgd = SGD(lr=learning_rate, decay=1e-6, momentum=0.09, nesterov=True)
